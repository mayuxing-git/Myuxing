...
class Meeting():
    ...
    def meeting_book(self):
        try:
            ...
            print('抱歉你所选择的所有会议室均被预定')


if __name__=="__main__":
    startTime='10:30:00'                   #预定会议室的起始时间，可自定义修改，目前仅支持一刻时间（即间隔15min）
    endTime='12:30:00'                     #预定会议室的截止时间，可自定义修改，目前仅支持一刻时间（即间隔15min）
