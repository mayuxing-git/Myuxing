...
from window_impl import get_virtual_keyboard_geometry
from image_manage import get_virtual_keyboard_box_time
...
class Task(object):
    ...
    def system_cold_start(self):
        ...
        item = get_virtual_keyboard_box_time(self.box)
    ...
    def run(self):
        if self.input == 'sogou':
            geom = get_virtual_keyboard_geometry('Sogou')
            self.box['top'] = geom.y
